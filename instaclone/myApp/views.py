...
CLIENT_ID = '7382064b90606f7'

CLIENT_SECRET = 'f8b589cd7b6ff1dfd69d59d3549e4b4a57744f5f'

PARALLEL_DOTS_KEY = "BdxrWHaw2MkbXuETjztw9vnoeCJzmXQAslmT1yt4drU"


#key has been changed because if placed on git account gets suspended
SEND_GRID_KEY = "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"
        ...
        if sign_up_form.is_valid():
            ...
            msg_payload = {
                ...
                "content": [
                    {
                        "type": "text/html",
                        "value": '<h1>Welcome to SocialKids</h1><br><br> Be social media friendly in the safest and most child friendly social environment in the world. <br> <br><h2><a href="sociokids.com"> Let\'s get started</a></h2>'
...
def checkImage(path):
    app = ClarifaiApp(api_key='a17828cabb3f42fd8556b7aa117aa57e')
    flag = False
